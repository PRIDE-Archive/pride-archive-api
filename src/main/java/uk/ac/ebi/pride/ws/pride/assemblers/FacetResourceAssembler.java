 ...
 */
@Slf4j
public class FacetResourceAssembler extends RepresentationModelAssemblerSupport<PrideSolrProject, FacetResource> {
    ...
    @Override
    public FacetResource toModel(PrideSolrProject entity) {
        return null;
    }

    @SuppressWarnings("unchecked")
    @Override
    public CollectionModel<FacetResource> toCollectionModel(Iterable<? extends PrideSolrProject> entities) {
        ...
        return CollectionModel.of(facets);
